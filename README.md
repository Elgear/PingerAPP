...
- Report: selectable troubleshooting report with preview and `.txt` export for Host Info, Adapter Info, ping stats, LAN Throughput, Gateway Stability, Loaded Latency, Route Health, Wi-Fi Diagnostics, Speed Test history, last DNS lookup, last traceroute, and Network Scanner results.
