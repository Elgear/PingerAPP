...
1. Bufferbloat / Loaded Latency Test
...
3. Route / Hop Health During Speed Test
...
- Report: selectable sections for Host Info, Adapter Info, ping stats, LAN Throughput, Gateway Stability, Speed Test history, last DNS lookup, last traceroute, and Network Scanner results, with preview and `.txt` save.
